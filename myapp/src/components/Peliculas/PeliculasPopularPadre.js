...
class PeliculasPopularPadre extends Component {
  constructor() {
    super();
    this.state = {
      movies: [],
  ...
  componentDidMount() {
    fetch(
      "https://api.themoviedb.org/3/movie/popular?api_key=8a83423231f73046d3a699212802bf6e&language=es-ES&page=" +
        this.state.num
    )
      .then((res) => res.json())
      .then((data) => {
...
export default PeliculasPopularPadre;
